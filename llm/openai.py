...
class BaseClient:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.prepare_messages_callback = prepare_messages_callback
        self.messages = []
    ...
    def _prepare_messages_for_api(self, messages: List[Dict[str, Any]]):
        ...
        """
        if self.prepare_messages_callback:
            messages = self.prepare_messages_callback(messages)
        return messages
    ...
    def get_response(self, prompt: Union[str, List[Dict[str, Any]]], **kwargs):
        ...
        if isinstance(prompt, list) and self.keep_history:
            raise ValueError(
                "keep_history must be False when passing a list of messages"
            )
